        ...
        <div class="row">
            <div class="col-md-12">
                <div class="alert alert-warning alert-dismissible" id="alert_produit" style="display:none;">
                    <h4><i class="icon fa fa-success-circle"></i> Alerte !</h4>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Client :</label>
                                    <input type="text" id="client" name="full_name" value="<?= $client['societe']?>" class="form-control" readonly>
                                    <small class="form-text text-success" id="ice"><?= $client['ICE']?></small>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>Ville :</label>
                                    <input type="text" id="ville" value="<?= $client['ville']?>" name="telephone" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Source :</label>
                                    <input type="text" id="source" value="<?= $client['source']?>" name="telephone" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Remarque :</label>
                                    <textarea class="form-control" value="<?= $client['remarque']?>" name="remarque" maxlength="200" rows="3"
            ...
            <div class="col-md-6">
                <div class="card card-info">
                                                ...
                                                <table class="table table-bordered table-striped" style="margin-bottom:0px;">
                                                    <tbody>
                                                            <tr>
                                                                ...
                                                                <td><input type="text" id="cheque_reference" name="reference_cheque" class="form-control" placeholder="Réference de Chèque"></td>
                                                                <td><input type="date" id="cheque_date" name="date_cheque" class="form-control" placeholder="Date"></td>
                                                            </tr>
                                                        <tr>
                    ...
                    <div class="card-footer" style="text-align: center;">
                        <button type="submit" id="subButton" style="width: 50%;" class="btn btn-info">
